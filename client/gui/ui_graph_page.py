...
class Ui_GraphPage(object):
    def setupUi(self, GraphPage):
        ...
        self.btn_file.setMaximumSize(QtCore.QSize(230, 60))
        ...
        self.btn_generate = QtWidgets.QPushButton(GraphPage)
        self.btn_generate.setMinimumSize(QtCore.QSize(0, 30))
        self.btn_generate.setMaximumSize(QtCore.QSize(230, 60))
        ...
        self.lbl_plug = QtWidgets.QLabel(GraphPage)
        self.lbl_plug.setText("")
        self.lbl_plug.setObjectName("lbl_plug")
        self.horizontalLayout_7.addWidget(self.lbl_plug)
        ...
        self.btn_draw.setMaximumSize(QtCore.QSize(230, 60))
        ...
        self.btn_embed.setMaximumSize(QtCore.QSize(230, 60))
    ...
    def retranslateUi(self, GraphPage):
        ...
        self.btn_generate.setText(_translate("GraphPage", "Сгенерировать граф"))
